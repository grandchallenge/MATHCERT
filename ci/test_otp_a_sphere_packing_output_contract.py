...
P=ROOT/"ci/validate_otp_a_sphere_packing_output_contract.py"
...
class T(unittest.TestCase):
 def e(self,r=None,s=None): return v.validation_errors(R if r is None else r,S if s is None else s)
