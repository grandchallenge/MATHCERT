...
def validation_errors() -> list[str]:
    ...
    if route.get("intake_status") == "submitted":
        ...
        if output != {
            ...
            "commit_sha": "b90305e91a7162a6dbc017e647d7a2d7272e1eef",
            "path": "certificates/formal_sources/MC-OTP-C-PERMANENT-CIRCUIT-001.json",
            "digest_algorithm": "git_blob_sha1",
            "digest": EXPECTED_CERT_BLOB,
        }:
            errors.append("qualified circuit route certificate output identity drift")
    else:
