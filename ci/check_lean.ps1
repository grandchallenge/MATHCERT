...
Invoke-Control "ci/validate_openai_ten_proofs_permanent_route_proposal.py"
Invoke-Control "ci/test_openai_ten_proofs_permanent_route_proposal.py"
...
Invoke-Control "ci/validate_otp_permanent_output_contract.py"
...
Invoke-Control "ci/validate_otp_compactness_construction_evidence.py"
Invoke-Control "ci/test_otp_compactness_construction_evidence.py"
Invoke-Control "ci/validate_otp_compactness_output_contract.py"
Invoke-Control "ci/test_otp_compactness_output_contract.py"
Invoke-Control "ci/validate_otp_compactness_output_execution.py"
...
Invoke-Control "ci/validate_otp_j2_source_faithful_evidence.py"
Invoke-Control "ci/test_otp_j2_source_faithful_evidence.py"
Invoke-Control "ci/validate_otp_j2_scope_repair.py"
