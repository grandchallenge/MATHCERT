#!/usr/bin/env python3
"""Validate the bounded OTP-D-NON-SOFIC MATHCERT intake successor."""
...
RECORD = ROOT / "governance/result_family_intake_successors/OTP-D-NON-SOFIC.json"
SCHEMA = ROOT / "schemas/openai_ten_proofs_non_sofic_result_family_intake_successor.schema.json"
...
EXPECTED_CANONICAL_SHA256 = "8665ccb74d8f4166c9f671a2c39b3f9f3e40451751120bb50715bb574bb399a6"
...
def validation_errors(data: dict[str, Any] | None=None, *, legacy_file_exists: bool | None=None) -> list[str]:
    ...
    if canonical_sha256(record)!=EXPECTED_CANONICAL_SHA256: errors.append("non-sofic successor intake exact content drift")
    ...
    if exists: errors.append("non-sofic successor inserted into frozen historical intake namespace")
    return errors
def main() -> int:
    errors=validation_errors()
    if errors: print("\n".join(errors),file=sys.stderr); return 1
    print("OTP-D-NON-SOFIC successor intake: PASS; exact derived target and zero route/output authority"); return 0
