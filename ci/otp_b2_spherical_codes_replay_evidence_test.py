...
P=ROOT/"ci/otp_b2_spherical_codes_replay_evidence.py"
...
R=json.loads((ROOT/"governance/result_family_replay_evidence_successors/OTP-B2-SPHERICAL-CODES.json").read_text()); S=json.loads((ROOT/"schemas/openai_ten_proofs_spherical_codes_replay_evidence.schema.json").read_text())
