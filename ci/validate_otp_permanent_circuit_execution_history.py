...
def main() -> int:
    ...
    if errors:
        ...
        print(f"OTP Permanent circuit execution history failed with {len(errors)} error(s)", file=sys.stderr)
        return 1
    print("validated OTP Permanent circuit candidate authorization and ancestry-preserving output execution")
    return 0
