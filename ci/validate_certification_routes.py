...
EXPECTED["OTP-F-EHRHART"]["state"] = "qualified"
EXPECTED["OTP-F-EHRHART"]["output"] = artifact(
    "grandchallenge/MATHCERT",
    "7b79b459422951cc6e36feda34c8a6e3d615ef17",
    "certificates/formal_sources/MC-OTP-F-EHRHART-001.json",
    "27a855c949b67e71372c7f0d6601d80125d33968",
)
...
def main() -> int:
    ...
    if found:
        ...
        return 1
    print("validated eleven exact routes, including bounded UC and OTP-F-EHRHART qualifications with two submitted OTP routes")
    return 0
