...
for fam in ("OTP-J1-COMPACTNESS","OTP-J2-TWO-DEGENERATE"):
 EXPECTED[fam]={"tracker":"https://github.com/grandchallenge/MATHCERT/issues/55","source":PROVIDER,"state":"submitted","packet":{"repository":"grandchallenge/MATHSOLVE","commit_sha":"443daf537dc7e4ee34ab43aeb01508d9177816ab","path":f"work_packages/OPENAI_TEN_PROOFS_WP00/result_family_handoffs/{fam}.json","digest_algorithm":"git_blob_sha1","digest":PACKETS[fam]},"output":None}
EXPECTED["OTP-F-EHRHART"]={"tracker":"https://github.com/grandchallenge/MATHCERT/issues/55","source":PROVIDER,"state":"qualified","packet":{"repository":"grandchallenge/MATHSOLVE","commit_sha":"443daf537dc7e4ee34ab43aeb01508d9177816ab","path":"work_packages/OPENAI_TEN_PROOFS_WP00/result_family_handoffs/OTP-F-EHRHART.json","digest_algorithm":"git_blob_sha1","digest":PACKETS["OTP-F-EHRHART"]},"output":{"repository":"grandchallenge/MATHCERT","commit_sha":"7b79b459422951cc6e36feda34c8a6e3d615ef17","path":"certificates/formal_sources/MC-OTP-F-EHRHART-001.json","digest_algorithm":"git_blob_sha1","digest":"27a855c949b67e71372c7f0d6601d80125d33968"}}
...
def main()->int:
 ...
 print("validated eleven exact routes, including one restricted qualified OTP route and two submitted OTP routes");return 0
