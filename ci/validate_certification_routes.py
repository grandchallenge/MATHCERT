...
EXPECTED["OTP-B2-SPHERICAL-CODES"]={
 "tracker":"https://github.com/grandchallenge/MATHCERT/issues/206",
 "source":art("grandchallenge/MATHFORGE","0520d8bae3853798f2edca67c526133e46847a54","sources/OPENAI-TEN-PROOFS-001/semantic/OTP-B2-SPHERICAL-CODES/audit_record.json","394d1211757d3fc2bc61b238e914b37245967635"),
 "state":"qualified",
 "packet":art("grandchallenge/MATHSOLVE","63efb94f28ecb12c55a492c2243a9f70d655f646","work_packages/OPENAI_TEN_PROOFS_WP00/result_family_handoff_successors/OTP-B2-SPHERICAL-CODES.json","0266c9a431ca4a8e84989913fc626a5086496da6"),
 "output":art("grandchallenge/MATHCERT","4d039b5e4c21ec7f089e5253877c4cb0a1692d7c","certificates/formal_sources/MC-OTP-B2-SPHERICAL-CODES-001.json","567294abc70d250a83647d4fd1fe82794c9203c8")}
EXPECTED["OTP-I-RAMSEY"]={
 "tracker":"https://github.com/grandchallenge/MATHCERT/issues/272",
 "source":art("grandchallenge/MATHFORGE","dbf3b099331a1807c4d3036e7a6a406711ea7cf3","sources/OPENAI-TEN-PROOFS-001/semantic/OTP-I-RAMSEY/audit_record.json","a7c014fb623b66355ef5d6260e5b994d99d67a6d"),
 "state":"qualified",
 "packet":art("grandchallenge/MATHSOLVE","a5b9488a4095a6669c9c242d59225c5735100123","work_packages/OPENAI_TEN_PROOFS_WP00/result_family_handoff_successors/OTP-I-RAMSEY.json","14e0909cd5e704d3a9b6b35c218fae6a44ae2013"),
 "output":art("grandchallenge/MATHCERT","18578b7f6917fec0bca4f9b5ea17fbb9541794e6","certificates/formal_sources/MC-OTP-I-RAMSEY-001.json","34e45c5dd08a3bb19fc27bc1f7da4ec71b3e1d31")}
EXPECTED["OTP-G-QUANTUM-PARALLEL-REPETITION"]={
 "tracker":"https://github.com/grandchallenge/MATHCERT/issues/277",
 "source":art("grandchallenge/MATHFORGE","f0a40146cca7fd39c5724ed5be033ee9092625ac","sources/OPENAI-TEN-PROOFS-001/semantic/OTP-G-QUANTUM-PARALLEL-REPETITION/audit_record.json","bfcbee0fd6174b8856b17c3d56ee320f27c18ec6"),
 "state":"qualified",
...
EXPECTED["OTP-E-CONNES-RIGIDITY"]={
 "tracker":"https://github.com/grandchallenge/MATHCERT/issues/284",
 "source":art("grandchallenge/MATHFORGE","ed8a65410336489ea5646808265c44f5387bebb8","sources/OPENAI-TEN-PROOFS-001/semantic/OTP-E-CONNES-RIGIDITY/audit_record.json","ab38a22d029bacc09d7567166b3b5e380f207f99"),
 "state":"qualified",
 "packet":art("grandchallenge/MATHSOLVE","07814c1e28855ff0314737d3666642217da095a1","work_packages/OPENAI_TEN_PROOFS_WP00/result_family_handoff_successors/OTP-E-CONNES-RIGIDITY.json","a2a76e5708245bd75c293713e1925617369c48ea"),
 "output":art("grandchallenge/MATHCERT","22d9ca44a64ec71aa4a0b77d87b55017ccf9949a","certificates/formal_sources/MC-OTP-E-CONNES-RIGIDITY-001.json","e135e4d7cd4eb752b25e1a940f970f224465191e")}
...
def route_errors(registry_path:Path=REGISTRY_PATH,schema_path:Path=SCHEMA_PATH)->list[str]:
 ...
 otp={"OTP-F-EHRHART","OTP-J1-COMPACTNESS","OTP-J2-TWO-DEGENERATE","OTP-C-PERMANENT","OTP-A-SPHERE-PACKING","OTP-H-GAPCVP","OTP-B2-SPHERICAL-CODES","OTP-B1-BINARY-CODES","OTP-I-RAMSEY","OTP-G-QUANTUM-PARALLEL-REPETITION","OTP-D-NON-SOFIC","OTP-E-CONNES-RIGIDITY"}
...
def main()->int:
 ...
 print("validated twenty exact routes, including restricted qualified OTP-E-CONNES-RIGIDITY, OTP-D-NON-SOFIC, OTP-G-QUANTUM-PARALLEL-REPETITION, OTP-I-RAMSEY, OTP-B2-SPHERICAL-CODES, OTP-H-GAPCVP, OTP-B1-BINARY-CODES, OTP-A-SPHERE-PACKING, OTP-F-EHRHART, OTP-J1-COMPACTNESS, OTP-J2-TWO-DEGENERATE, and OTP-C-PERMANENT routes")
 return 0
