...
P=ROOT/"ci/otp_b1_binary_codes_replay_evidence.py"
...
R=json.loads((ROOT/"governance/result_family_replay_evidence_successors/OTP-B1-BINARY-CODES.json").read_text()); S=json.loads((ROOT/"schemas/openai_ten_proofs_binary_codes_replay_evidence.schema.json").read_text())
