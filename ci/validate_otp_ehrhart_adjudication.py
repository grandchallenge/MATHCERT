...
def validation_errors(
    *,
    ...
    routes = predecessor_routes(copy.deepcopy(default_routes if routes is None else routes))
    errors: list[str] = []
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print("validated protected OTP-F-EHRHART adjudication snapshot against its submitted-route predecessor; successor qualification is governed separately")
    return 0
