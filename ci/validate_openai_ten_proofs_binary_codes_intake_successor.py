...
def validate_repository_guards() -> None:
    ...
    if "OTP-B1-BINARY-CODES" in route_text or OWN_ROUTE_ID in route_text:
        raise ValueError("binary-codes route authority already present during intake-only operation")
...
def main() -> None:
    ...
    print("OTP-B1-BINARY-CODES successor intake validation: PASS; immutable intake preserved across exact separately governed A registration successor")
